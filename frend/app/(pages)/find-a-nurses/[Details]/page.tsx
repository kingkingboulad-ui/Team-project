  ...
  return (
    <main className="min-h-screen bg-[#F5FAFA]">
      ...
      <header className="border-b-2 border-slate-100 bg-white">
        <div className="mx-auto flex min-h-[58px] max-w-6xl items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">

          <Link
            href="/"
            className="flex shrink-0 items-center gap-2"
          >
            <div className="flex h-7 w-7 items-center justify-center rounded bg-[#00535B]">
              <HeartPulse
                size={16}
            ...
            <span className="text-sm font-bold text-[#00535B]">
              NurseConnect
            </span>
          </Link>

          <nav className="hidden items-center gap-6 text-[10px] font-medium text-slate-500 md:flex">
            <Link href="/" className="hover:text-[#00535B]">
              Home
            </Link>

            <Link
              href="/find-a-nurses"
              className="rounded bg-[#E6F4F1] px-3 py-1.5 font-semibold text-[#00535B]"
            >
              Find a Nurse
            </Link>
          ...
          <div className="flex shrink-0 items-center gap-2 sm:gap-3">
            ...
            <Link
              href="/login"
              className="hidden text-[10px] font-medium text-slate-500 sm:block"
            >
              Sign in
            </Link>
            ...
            <Link
              href="/find-a-nurses"
              className="rounded bg-[#00535B] px-3 py-2 text-[9px] font-semibold text-white sm:px-4"
            >
              Find a Nurse
            </Link>
      ...
      <footer className="mt-8 bg-[#1C2E4A] text-white">
        ...
        <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 gap-7 sm:grid-cols-4">
            ...
            <div className="col-span-2 sm:col-span-1">
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="flex h-7 w-7 items-center justify-center rounded bg-[#006D77]">
                  <HeartPulse size={15} />
                </div>
              ...
              <p className="mt-3 max-w-[210px] text-[8px] leading-4 text-white/60">
                Connecting families with trusted professional nurses
            ...
            <div>
              ...
              <div className="mt-3 space-y-2 text-[8px] text-white/60">
                <Link
                  href="/find-a-nurses"
                  className="block"
                >
          ...
          <div className="mt-7 border-t-2 border-white/10 pt-4 text-[7px] text-white/40">
            © 2026 NurseConnect. All rights reserved.
          </div>
